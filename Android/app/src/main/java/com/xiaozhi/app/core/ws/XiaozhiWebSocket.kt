package com.xiaozhi.app.core.ws
...
class XiaozhiWebSocket {
    ...
    data class Hello(
        ...
        data class AudioParams(
            ...
            val sample_rate: Int = com.xiaozhi.app.core.audio.AudioConfig.SAMPLE_RATE,
            val channels: Int = com.xiaozhi.app.core.audio.AudioConfig.CHANNELS,
            val frame_duration: Int = com.xiaozhi.app.core.audio.AudioConfig.FRAME_DURATION_MS
        )
    }
