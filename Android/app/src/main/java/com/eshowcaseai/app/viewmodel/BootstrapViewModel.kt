package com.eshowcaseai.app.viewmodel
...
import com.eshowcaseai.app.core.activation.Activator
import com.eshowcaseai.app.core.audio.AudioPipeline
import com.eshowcaseai.app.core.identity.DeviceIdentity
import com.eshowcaseai.app.core.ota.OtaClient
import com.eshowcaseai.app.core.ws.EShowcaseAIWebSocket
...
class BootstrapViewModel(app: Application) : AndroidViewModel(app) {
    ...
    private val ws = EShowcaseAIWebSocket()
        ...
        viewModelScope.launch {
            ...
            if (!info.isActivated && ota.activation != null) {
                ...
                try {
                    ...
                    android.util.Log.e("EShowcaseAI", "激活异常", e)
            ...
            val params = EShowcaseAIWebSocket.Params(
                url = wsConfig.url,
            ...
            ws.connect(params, object : WebSocketListener() {
                ...
                override fun onOpen(webSocket: WebSocket, response: Response) {
                    ...
                    val helloMsg = EShowcaseAIWebSocket.Hello()
                    val jsonStr = Json { encodeDefaults = true }.encodeToString(EShowcaseAIWebSocket.Hello.serializer(), helloMsg)
                    ...
                    heartbeatJob = viewModelScope.launch {
                        while (true) {
                            ...
                            val sid = sessionId
                            if (sid != null) {
                                // android.util.Log.d("EShowcaseAI", "Sending heartbeat...")
                ...
                override fun onMessage(webSocket: WebSocket, text: String) {
                    android.util.Log.i("EShowcaseAI", "[WS] <- $text")
                    appendLog("WS <- $text")
                    try {
                        ...
                        if (sid != null) {
                            if (sid != sessionId) {
                                sessionId = sid
                                android.util.Log.i("EShowcaseAI", "✅ 已就緒 (SessionId: $sid)")
                        ...
                        android.util.Log.e("EShowcaseAI", "解析失敗: ${e.message}")
