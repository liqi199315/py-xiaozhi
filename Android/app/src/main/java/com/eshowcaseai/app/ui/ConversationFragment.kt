...
import com.eshowcaseai.app.databinding.FragmentConversationBinding
...
class ConversationFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        try {
            android.util.Log.i("EShowcaseAI", "Initializing Live2D SDK...")
            binding.live2dView.initSDK(requireActivity())
            android.util.Log.i("EShowcaseAI", "Live2D SDK Initialized.")
        } catch (e: Exception) {
            android.util.Log.e("EShowcaseAI", "Failed to initialize Live2D SDK", e)
        }
        ...
        viewModel.isListening.observe(viewLifecycleOwner) { isListening ->
            ...
            if (isListening) {
                startAuraAnimation(com.eshowcaseai.app.R.drawable.bg_aura_listening)
        ...
        binding.live2dView.onReady = {
            viewModel.isSpeaking.observe(viewLifecycleOwner) { isSpeaking ->
                ...
                if (isSpeaking) {
                    startAuraAnimation(com.eshowcaseai.app.R.drawable.bg_aura_speaking)
