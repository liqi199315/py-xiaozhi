...
//         前回セーブされた状態をロード
        ...
        if (lipSync) {
            ...
            // Use external lip sync value if set
            float value = externalLipSyncValue;
    ...
    /**
     * External lip sync value (0.0 to 1.0)
     */
    private float externalLipSyncValue = 0.0f;

    /**
     * Set the lip sync value externally.
     * @param value 0.0 to 1.0
     */
    public void setLipSyncValue(float value) {
        this.externalLipSyncValue = value;
    }
}
