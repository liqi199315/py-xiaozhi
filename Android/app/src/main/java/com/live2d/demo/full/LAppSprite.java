...
public class LAppSprite {
    public LAppSprite(
        ...
        this.rect.left = x - width * 0.5f;
        this.rect.right = x + width * 0.5f;
        this.rect.up = y + height * 0.5f;
        this.rect.down = y - height * 0.5f;
    ...
    public void render() {
        if (positionLocation == -1 || uvLocation == -1 || programId == 0) return;
